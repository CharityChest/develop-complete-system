...
OAUTH_FORWARD_TOOL_CLIENT_PATH="$ROOT_PATH/oauth2-forward-tool-client"
...
OAUTH_FORWARD_TOOL_SERVER_VARIABLES_FILE="$OAUTH_FORWARD_TOOL_SERVER_PATH/docker/.node_configuration.env"
OAUTH_FORWARD_TOOL_CLIENT_VARIABLES_FILE="$OAUTH_FORWARD_TOOL_CLIENT_PATH/docker/.node_configuration.env"
